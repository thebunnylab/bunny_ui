//! Two windows, by hand — the proof that one pump can hold more than
//! one scene.
//!
//! ```sh
//! cargo run -p bunny-ui-windows --example two_windows
//! ```
//!
...
//! 5. A popover opened in one window belongs to THAT window's scene:
//!    it hangs from it, and clicking it never reaches the other.
...
fn main() {
    ...
    use bunny_ui_windows::{App, DirectWriteEngine, WicImageEngine, WindowSpec};
