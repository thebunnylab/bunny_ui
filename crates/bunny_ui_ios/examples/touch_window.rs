...
//! — and the safe area painted honestly: colored bands at the notch and
//! the home indicator, and a one-point frame on the window's own four
...
fn main() {
    ...
    bunny_ui_ios::run_window("touch", Size { width: 390.0, height: 844.0 }, playground);
}
